...
> {{one_line_pitch}}
>
> Built with the [`choose-your-path`](https://github.com/SagarDevExpo/oracle-ai-developer-hub/tree/main/choose-your-path) skill set from Oracle AI Developer Hub. Path: **{{path}}** ({{topic}}).
